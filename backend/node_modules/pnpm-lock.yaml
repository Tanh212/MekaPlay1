...
importers:
  ...
  .:
    dependencies:
      json-server-auth:
        specifier: ^2.1.0
        version: 2.1.0(json-server@1.0.0-beta.3)
...
packages:
  ...
  json-server-auth@2.1.0:
    resolution: {integrity: sha512-uf6rud43cH+bfOqA+kqSqdNdVtOj56qJ6nNKH6nAZ8bFxpMY9zzthgK9trrvkVDzihqLfvZ0rwWnGZHACNckGA==}
    engines: {node: '>=10'}
    hasBin: true
    peerDependencies:
      json-server: '*'
  ...
  sort-on@6.1.0:
    resolution: {integrity: sha512-WTECP0nYNWO1n2g5bpsV0yZN9cBmZsF8ThHFbOqVN0HBFRoaQZLLEMvMmJlKHNPYQeVngeI5+jJzIfFqOIo1OA==}
    engines: {node: '>=18'}
...
snapshots:
  ...
  json-server-auth@2.1.0(json-server@1.0.0-beta.3):
    dependencies:
      bcryptjs: 2.4.3
      json-server: 1.0.0-beta.3
      jsonwebtoken: 8.5.1
